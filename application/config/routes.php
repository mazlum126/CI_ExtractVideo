...
$route['venuesListing'] = 'admin/venuesListing';
$route['showAddVenueForm'] = 'admin/showAddVenueForm';
$route['getInstagramStories'] = 'admin/getStories';
$route['addNewVenue'] = 'admin/addNewVenue';
$route['showEditVenueForm/(:num)'] = "admin/showEditVenueForm/$1";
$route['editVenue'] = "admin/editVenue";
$route['deleteVenue'] = "admin/deleteVenue";
$route['djsListing'] = "admin/djsListing";
$route['eventsListing'] = "admin/eventsListing";
